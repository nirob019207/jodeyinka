    ...
    <div className="bg-[#F6F6F6]">
      <div className="container px-0  flex flex-col lg:flex-row  relative bottom-[176px] ">
        ...
        <div className="bg-white rounded-bl-xl rounded-br-xl shadow-lg flex-1 relative">
          <div className="absolute top-0 left-0 w-full bg-[#FFFFFF] text-[#1D2939] py-2 px-4">
          ...
          <div className="relative overflow-hidden">
            <Image
              ...
              alt="Membership"
              width={500}
              className="w-full overflow-hidden pt-[59px]"
            />
            <div className="absolute inset-0 bg-black/50"></div>
            <div className="absolute inset-0 flex items-center justify-center  px-6">
              <p className="text-[#FFFFFF] text-[20px] lg:text-[24px] font-medium">
          ...
          <div className="flex items-center justify-end mt-4 text-blue-600 font-medium">

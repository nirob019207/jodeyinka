  ...
  return (
    <section className="bg-[#F6F6F6] pt-[30px] md:pt-[60px pb-[60px] font-inter px-6 md:px-0">
      <div className="container mx-auto px-0">
        <h2 className="text-2xl font-semibold mb-6 text-default text-center md:text-start">
          Related Books
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {books.map((book) => (
            ...
            >
              ...
              />
              <div className="p-4">
                <h3 className="text-lg md:text-[20px] font-medium text-[#10375C] truncate mb-2">
                  {book.title}
                </h3>
                <p className="text-[12px] text-[#10375C] mb-4">
                  By: {book.author}
                </p>
